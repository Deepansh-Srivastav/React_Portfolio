...
import { aboutSectionData } from "../data/homePageData"
    ...
    <section className="about_section">
      <div className="row">
        <div className="col-12 col-md-6 ">
          <div className="image_container d-flex flex-row justify-content-center align-items-end">
        ...
        <div className="col-12 col-md-6">
          <div className="py-5">
            <Heading_Type_1 {...aboutSectionData} />
